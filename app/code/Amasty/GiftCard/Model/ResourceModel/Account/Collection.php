...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function savedByCustomer($customerId)
    {
        if ($customerId) {
            $this->getSelect()->join(
                ['customer_card' => $this->getTable('amasty_amgiftcard_customer_card')],
    ...
    public function joinOrder()
    {
        $this->getSelect()->joinLeft(
            ...
            ['order_number' => 'order.increment_id', 'order.store_id']
        );
        return $this;
    }
    ...
    {
        $this->getSelect()->join(
            ['code' => $this->getTable('amasty_amgiftcard_code')],
    ...
    {
        $this->addFilterToMap('gift_code', 'code');
