...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'brownbagpresentation/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'brownbagpresentation/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'brownbagpresentation/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'brownbagpresentation/images/file';
